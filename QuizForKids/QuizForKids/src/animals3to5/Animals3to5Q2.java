...
/**
 * Class for the 2nd Question in the Animals round of the 3to5yr old
 * @author chrismcclune
 *
 */
public class Animals3to5Q2 extends MainActivity {
	...
	private void nextPageButton() {
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				// Intent to change the screen to the next question screen
