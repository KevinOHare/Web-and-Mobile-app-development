...
/**
 * Class for the 3rd Question in the Shapes round of the 3to5yr old
 * @author chrismcclune
 *
 */
public class Shapes3to5Q3 extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shapes3to5_q3);
	...
	private void nextPageButton() {
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent changeScreen = new Intent(Shapes3to5Q3.this,
						Shapes3to5Q4.class);
