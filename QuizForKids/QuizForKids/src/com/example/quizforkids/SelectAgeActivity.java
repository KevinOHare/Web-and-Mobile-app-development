	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		age3to5.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent pageSwitch3to5 = new Intent(SelectAgeActivity.this, LevelSelect3to5.class);
		...
		age5to7.setOnClickListener(new View.OnClickListener() {
			...
			@Override
			public void onClick(View v) {
				Intent pageSwitch5to7 = new Intent(SelectAgeActivity.this, LevelSelect5to7.class);
