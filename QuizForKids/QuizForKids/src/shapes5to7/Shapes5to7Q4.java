...
/**
 * Class for the 4th Question in the Shapes round of the 5to7yr old
 * @author chrismcclune
 *
 */
public class Shapes5to7Q4 extends MainActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		setContentView(R.layout.activity_shapes5to7_q4);
	...
	private void nextPageButton() {
		...
		btn.setOnClickListener(new View.OnClickListener() {
			...
			public void onClick(View v) {
				...
				Intent changeScreen = new Intent(Shapes5to7Q4.this,
						Shapes5to7Q5.class);
